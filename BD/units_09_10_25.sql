...
COPY public.persons (idperson, family, name, parent, current_unit, codes_prever_units) FROM stdin;
1	Воронин	Святослав	Петрович	31	\N
2	Гришенков	Владимир	Дмитриевич	31	\N
3	Батенков	Кирилл	Александрович	31	\N
4	Козленков	Андрей	Владимирович	31	\N
5	Кузнецов	Андрей	Викторович	31	\N
6	Никольский	Павел	Геннадьевич	31	\N
7	Андреев	Александр	Юрьевич	20	\N
8	Орлов	Евгений	Владимирович	20	\N
9	Лабунец	Артем	Владимирович	26	\N
10	Колосов	Сергей	Александрович	26	\N
11	Пилюгин	Олег	Игоревич	26	\N
\.
...
SELECT pg_catalog.setval('public.persons_idperson_seq', 11, true);
